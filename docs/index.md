...
- [チーム開発に当たって](#チーム開発に当たって)
  - [反省点](#反省点)
    - [最初の抽象的な方向決めを適切に行えなかった](#最初の抽象的な方向決めを適切に行えなかった)
    - [割とデカめの仕様変更を途中で2回挟んだ](#割とデカめの仕様変更を途中で2回挟んだ)
    - [チームメンバーがGitHubにあまり慣れていない状態で導入](#チームメンバーがgithubにあまり慣れていない状態で導入)
    - [プログラムを書けるのが3人しかいないのなら、別のモダンな言語を選択できたのではないか](#プログラムを書けるのが3人しかいないのなら別のモダンな言語を選択できたのではないか)
  - [開発小話](#開発小話)
  - [チームメンバー](#チームメンバー)
