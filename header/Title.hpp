...
private:
   ...
   int BUTTON_NUM{ 2 };
	...
	int select{ 0 };
    Button* button[2]{ new Button(1,0,960 - 100 - 650,700,1,1,LoadGraph("image\\buttonStart.png")),
                       new Button(1,0,960 + 100,700,1,1,LoadGraph("image\\buttonEnd.png")) };
    Graphics* backGround{new Graphics( 0,0,1,1,LoadGraph("image\\backGround.jpg")) };
    Graphics* titleZimaku{ new Graphics(0,0,1,1,LoadGraph("image\\titlezimaku.png")) };
